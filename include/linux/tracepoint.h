...
extern int kabi_2635_tracepoint_probe_unregister(const char *name, void *probe, void *data);

extern int tracepoint_probe_register_noupdate(const char *name, void *probe);
extern int kabi_2635_tracepoint_probe_register_noupdate(const char *name, void *probe,void *data);
extern int tracepoint_probe_unregister_noupdate(const char *name, void *probe);
extern int kabi_2635_tracepoint_probe_unregister_noupdate(const char *name, void *probe,void *data);
